...
const paths = {
  ...
  adocPath: pathResolve('./src/nv-resume.adoc'),
  outPath: pathResolve('./dist/nv-resume.pdf'),
  coverPath: pathResolve('./assets/book-cover-blank.pdf'),
  tempOrigAsciidocPDF: pathResolve('./tmp/tempOrigAsciidocPDF.pdf'),
...
async function renderNewPDF() {
  ...
  const origPdfRaw = readFileSync(paths.tempOrigAsciidocPDF);
